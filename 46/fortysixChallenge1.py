    ...
    def initUI(self, frequency_to_word_dict):
        ...
        for frequency in frequencies:
            ...
            for word in words:
                ...
                single_row_layout = QtGui.QFormLayout()
                single_row_layout = QtGui.QHBoxLayout()
                single_row_layout.addWidget(progress_bar)
                single_row_layout.addWidget(number_of_occurances_label)
